...
- **Direct Songs Upload** - So we aren't storing these audio files in repo here is the command to sync the songs folder to the remote from the birthday-app folder:

```
rsync -avz --delete ./songs/ root@192.241.231.56:/var/www/birthday-app/songs/
```
